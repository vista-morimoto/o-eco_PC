...
var makeSrc=function(arr){
	...
	$(arr).each(function(){
		...
		src+='</ul>\n';
		src+='<p><a title="参加のお申し込みはこちら" target="'+this[4]+'" href="http://www.com-forms.jp/appform/form/index/id/ocaeco_taiken&amp;menu1=e:'+this[6]+'"><img width="210" height="35" alt="参加お申し込み" src="img/btnSanka.gif"></a></p>\n';
		src+='</div>\n';
		src+='</div>\n';
	});
	src+='</div>\n';
